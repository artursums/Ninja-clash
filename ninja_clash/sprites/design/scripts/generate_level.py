...
import os
os.makedirs('/sessions/nice-zen-rubin/mnt/outputs/backgrounds/dungeon', exist_ok=True)
native_path = '/sessions/nice-zen-rubin/mnt/outputs/backgrounds/dungeon/dungeon_level_320x240.png'
img.save(native_path)

# Upscale 4x with nearest-neighbor for crisp pixels
upscaled = img.resize((W*4, H*4), Image.NEAREST)
upscaled_path = '/sessions/nice-zen-rubin/mnt/outputs/backgrounds/dungeon/dungeon_level_1280x960.png'
upscaled.save(upscaled_path)

# Also a 2x version for in-engine flexibility
img.resize((W*2, H*2), Image.NEAREST).save('/sessions/nice-zen-rubin/mnt/outputs/backgrounds/dungeon/dungeon_level_640x480.png')
