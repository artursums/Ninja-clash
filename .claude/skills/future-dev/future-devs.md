...
Logged ideas to implement later. Each row links to a self-contained task file whose
"Prompt for Claude" section can be pasted into a fresh Claude Code session.

| ID | Title | Area | Priority | Status | Link |
|----|-------|------|----------|--------|------|
| DEV-001 | Pre-match Fight Setup / Variants menu (TowerFall-style) | systems / UI / gameplay | P2 | 🔵 Backlog | [DEV-001](tasks/DEV-001-fight-setup-variants-menu.md) |
| DEV-002 | AI enemy behavior rework — full toolkit, environment use, last-resort head-stomp | AI / gameplay | P1 | 🔵 Backlog | [DEV-002](tasks/DEV-002-ai-enemy-behavior-rework.md) |
