...
> **Author**: level-designer agent + orchestrator
...
- **Map GDD** (`design/gdd/map.md`): spawn rotation rules, loading state, validator requirements.
- **Round Flow GDD** (`design/gdd/round-flow.md`): how rounds consume map data.
- **Combat GDD** (`design/gdd/combat.md`): throw velocity, projectile gravity (the disputed value).
...
- **Art Bible** (`design/art-bible.md`): tile palette skins per map, decorative props, native resolution.
- **Game Concept** (`design/gdd/game-concept.md`): no-hazards-no-pickups v1 constraint, scope.
